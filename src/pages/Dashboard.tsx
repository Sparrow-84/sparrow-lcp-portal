...
export function Dashboard() {
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-phone flex-col bg-sparrow-mist">
      <header className="sticky top-0 z-10 flex items-center justify-between border-b border-sparrow-rule bg-white px-4 py-3">
        <Wordmark />
